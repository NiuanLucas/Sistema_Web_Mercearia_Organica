...
<table class="table-condensed table-info-cadastro">
        ...
        <div class="panel-footer">
      		<div class="col-sm-offset-2">
         	 	...
         	 	<a class="btn btn-danger" href="produto.php?action=<?php echo(ACAO_EXIBIR_LEITURA); ?>&prod_id=<?php echo($prod_id); ?>&excluir=1"><i class="glyphicon glyphicon-remove"></i> apagar produto</a>&nbsp;&nbsp;
...
<?php 
  ...
  // REMOVE TABLE
        ...
        $excluir = "DELETE FROM produtos ";
        $excluir .= "WHERE  prod_id = {$pID} ";
