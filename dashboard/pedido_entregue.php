		...
		$texto_indicador_categoria_preco = "<span class='label label-info'>para o seu caso, vale este </span>&nbsp;";
		  ...
		  ?>  
           ...
           <tr>
             ...
             <td>
             <?php echo($cha_taxa_percentual) * 1; ?>
             <!-- <?php echo(formata_moeda($total_associado*$cha_taxa_percentual));?> -->
             </td>
           </tr> 

           <!--<tr>
          	 <td colspan="6"><div align="right">taxa de <?php echo($cha_taxa_percentual) * 1; ?>% para associado</div></td> 
             <td><?php echo(formata_moeda($total_associado*$cha_taxa_percentual));?></td>
           </tr> -->

			<tr>
          	 <th colspan="6"><div align="right">TOTAL FINAL</div></th> 
             <th>R$ <?php echo(formata_moeda($ped_usr_associado==1 ? $total_associado + ($cha_taxa_percentual) : $total_nao_associado ));?></th>
           </tr>
