...
$res = executa_sql($sql);
		...
		if($res && isset($cestante_pedido))
		{
            ...
            <thead> 
             <tr>
               <th colspan="<?php echo($num_colunas); ?>" style="text-align:left;vertical-align:middle"> AAA Núcleo <?php echo($nuc_nome_curto); ?> - Pedido de <?php echo($prodt_nome); ?> - Entrega em <?php echo($cha_dt_entrega); ?> </th>            
             </tr>		
               <tr>
               	<th colspan="2">&nbsp;</th>
                ...
                <th style='text-align:right'  colspan="2">  </th>
                  ...
                  {                                                                                              
                   ...
                   echo($cestante_associado[$i]==0 ? "CCC Não" : "CCC Sim");
                   echo("</th>");
                  }                                            
                  ?> 
		   ...
		   while ($row = mysqli_fetch_array($res,MYSQLI_ASSOC)) 
		   {
				...
				{					
					if($ultimo_forn!="")
					{
						...
						?>
                        <tr>
				         	<th colspan="4" style="text-align:right"> FFF SUBTOTAL <?php echo($ultimo_forn);?> </th>
						  <?php	
						  $total=0;
						  $total_entregue=0;
                           ...
                           for ($i = 0; $i < count($cestante_nome); $i++)
                           {	                                                                                            
                                echo("<th colspan='2' style='text-align:center'> C1 R$ " . formata_moeda($cestante_valor_fornecedor[$i]) .  "</th>");
								echo("<th colspan='2' style='text-align:center'> C2 R$ " . formata_moeda($cestante_valor_fornecedor_entregue[$i] - $cestante_valor_fornecedor[$i] ) .  "</th>");		
								echo("<th colspan='2' style='text-align:center'> C3 R$ " . formata_moeda($cestante_valor_fornecedor_entregue[$i]) .  "</th>");	
                           ...
                           ?> 
                           <th colspan="2" style="text-align:center"> C4 R$ <?php echo(formata_moeda($total));?></th>
						   <th colspan="2" style="text-align:center"> C5 R$ <?php echo(formata_moeda($total_entregue - $total));?></th>
						   <th colspan="2" style="text-align:center"> C6 R$ <?php echo(formata_moeda($total_entregue));?></th>
                           <th style="text-align:center"> C7 R$ <?php echo(formata_moeda($total_recebido_fornecedor));?></th>
						   <th style="text-align:center"> C8 R$ <?php echo(formata_moeda($total_nao_distribuido));?></th>
                       </tr>
					...
					?>
                          <tr>
                            <th rowspan="2">B1 <?php echo($row["forn_nome_curto"]);?></th>
                            <th rowspan="2">B2 Unidade</th>
                            <th rowspan="2" class="hidden">B3 Associado (R$)</th>
                            <th rowspan="2">B4 Preço (R$)</th>                            
						 	 <?php
                     	      	foreach ($cestante_nome as $cestante) echo("<th colspan='6' style='text-align:center'>$cestante JJJ</th>");
                             ?> 
							<th colspan="6" style='text-align:center'> D1 TOTAL Entregue aos Cestantes</th>
                            <!-- <th colspan="3"> D2 TOTAL Recebido pelo Núcleo</th>  -->                                                       
                          </tr>
                          <tr>
						 	 <?php
                     	      	foreach ($cestante_nome as $cestante) 
								{
									echo("<th> F1 pedido</th><th>F11 R$</th>");
									//echo("<th> F2 extra</th><th>F22 R$</th>");			
									//echo("<th> F3 entregue</th><th>F33 R$</th>");								
                             ...
                             <th>E6 R$</th>
                             <!-- <th>E7 recebido</th> -->
                             <!-- <th nowrap="nowrap">E8 recebido e não distribuído</th> -->
                             <!-- <th>E9 justificativa</th> -->
				...
				?>
				<tr> 
				<td>G1 <?php echo($row["prod_nome"]);?><?php if($row["chaprod_disponibilidade"]==1) echo("&nbsp;(parcial)");?></td>
				<td>G2 <?php echo($row["prod_unidade"]);?></td>
				<!-- <td>G3 <?php //echo(formata_moeda($row["prod_valor_venda"]));?></td> -->
				<td>G4 <?php echo(formata_moeda($row["prod_valor_venda_margem"]));?></td>
				  ...
				  $total_entregue=0.0;
                   ...
                   {	
						...
						{																	
	                        echo("<td>H1 " . formata_numero_de_mysql($row["pedprod_quantidade"]) .  "</td>");	
    	                    echo("<td>H2 " . formata_moeda($a_pagar) .  "</td>");		
						}
						else
						{
						...
						{																	
	                        //echo("<td> H3 " . formata_numero_de_mysql($row["pedprod_entregue"] - $row["pedprod_quantidade"]) .  "</td>");	
    	                    //echo("<td> H4" . formata_moeda($a_pagar_entregue - $a_pagar) .  "</td>");
						}
						else
						{
							//echo("<td>XXX -</td><td>XXX -</td>");							
						...
						{																	
							...
							//echo("</td>");	
    	                    //echo("<td>J2 " . formata_moeda($a_pagar_entregue) .  "</td>");	
						}
						else
						{
							//echo("<td>XXX -</td><td>XXX -</td>");							
                ...
                <td>K1 <?php echo(formata_numero_de_mysql($total_qtde_produto));?></td>                   
				<td>K2 <?php echo(formata_moeda($total)); ?></td>                                                                       
                <!-- <td>K3 <?php //echo(formata_numero_de_mysql($total_qtde_produto_entregue - $total_qtde_produto));?></td> -->           
				<!-- <td>K4 <?php // echo(formata_moeda($total_entregue - $total)); ?></td>    -->          
                <td>K5 <?php echo(formata_numero_de_mysql($total_qtde_produto_entregue));?></td>                   
				<td>K6 <?php echo(formata_moeda($total_entregue)); ?></td>          
				<!-- <td>K7 <?php // echo_digitos_significativos($total_qtde_recebido_fornecedor);?></td>-->                                   
                 <!-- <td>K8 <?php // echo(formata_numero_de_mysql($total_qtde_recebido_fornecedor));?></td> -->
				<?php
                    $classe=""; 
                ...
                ?>                                
                <!-- <td class="<?php // echo($classe);?>">L1 <?php //echo_digitos_significativos($total_qtde_recebido_fornecedor - $total_qtde_produto_entregue);?></td>     -->          
				<!-- <td>L2 <?php // echo($dist_just_dif_entrega[$row["prod_id"]]);?></td>   -->                      
				...
				<?php
						...
						?>
                        <tr>
				         	<th colspan="4" style="text-align:right"> Q1 SUBTOTAL <?php echo($ultimo_forn);?> </th>
						  <?php	
						  $total=0;
						  $total_entregue=0;				
                           ...
                           for ($i = 0; $i < count($cestante_nome); $i++)
                           {	                                                                                            
                                echo("<th colspan='2' style='text-align:center'> Z1 R$ " . formata_moeda($cestante_valor_fornecedor[$i]) .  "</th>");
								echo("<th colspan='2' style='text-align:center'>Z2 R$ " . formata_moeda($cestante_valor_fornecedor_entregue[$i] - $cestante_valor_fornecedor[$i] ) .  "</th>");		
								echo("<th colspan='2' style='text-align:center'>Z3 R$ " . formata_moeda($cestante_valor_fornecedor_entregue[$i]) .  "</th>");	
                           ...
                           ?> 
                           <th colspan="2" style="text-align:center">V4 R$ <?php echo(formata_moeda($total));?></th>
						   <th colspan="2" style="text-align:center">V5 R$ <?php echo(formata_moeda($total_entregue - $total));?></th>
						   <th colspan="2" style="text-align:center">V6 R$ <?php echo(formata_moeda($total_entregue));?></th>
                           <th style="text-align:center">V7 R$ <?php echo(formata_moeda($total_recebido_fornecedor));?></th>
						   <th style="text-align:center">V8 R$ <?php echo(formata_moeda($total_nao_distribuido));?></th>    
           ...
           <tr>
            <th colspan="4" style="text-align:right">Q2 cestante</th>
				  <?php
                   for ($i = 0; $i < count($cestante_nome); $i++)
                   {																		
                        echo("<th colspan='6' style='text-align:center'>N1 " . $cestante_nome[$i] .  "</th>");										
                   }                                            
                   ?>                  
            <th colspan="6"  style="text-align:center">M2 TOTAL Entregue aos Cestantes</th>          
            <th colspan="3"> M1 TOTAL Recebido pelo Núcleo</th> 
            </tr>

           <tr>
            <th colspan="4" style="text-align:right">Q5 somatório</th>
				  <?php
                   for ($i = 0; $i < count($cestante_nome) + 1; $i++)
                   {					   
                       echo("<th colspan='2'>N2 pedido</th>");
                       echo("<th colspan='2'>N3 extra</th>");	
                       echo("<th colspan='2'>N4 entregue</th>");
                   }                                            
                   ?>                  
            <th>N5 recebido</th>
            <th>N6 recebido e não distribuído</th>
            <th>N7 &nbsp;</th>            
           ...
           <tr>
            <th colspan="4" style="text-align:right">Q3 total sem taxa</th>
				  <?php
				  $total=0.0;
				  $total_entregue=0.0;
                   for ($i = 0; $i < count($cestante_nome); $i++)
                   {
                       ...
                       echo("<td colspan='2'> N8 R$ " . formata_moeda($cestante_valor[$i]) .  "</td>");										
                       echo("<td colspan='2'> N9 R$ " . formata_moeda($cestante_valor_entregue[$i] - $cestante_valor[$i]) .  "</td>");					   
                       echo("<td colspan='2'> N10 R$ " . formata_moeda($cestante_valor_entregue[$i]) .  "</td>");															
						
                   }                                            
                   ?>                  
            <th colspan="2">T1 R$ <?php echo(formata_moeda($total)); ?></th>
            <th colspan="2">T2 R$ <?php echo(formata_moeda($total_entregue - $total)); ?></th>  
            <th colspan="2">T3 R$ <?php echo(formata_moeda($total_entregue)); ?></th>
            
            <th>T4 R$ <?php echo(formata_moeda($total_final_recebido_fornecedor)); ?></th>
            <?php
				$classe=""; 
			...
			?>
            <th class="<?php echo($classe);?>">T5 R$ <?php echo(formata_moeda($total_final_nao_distribuido)); ?>
             </th>
            <th>&nbsp;</th>
           ...
           <tr>
            <th colspan="4" style="text-align:right">T6 taxa de <?php echo($cha_taxa_percentual) * 100; ?>% para associado</th>
				  <?php
				  $total=0.0;
				  $total_entregue=0.0;
                   for ($i = 0; $i < count($cestante_nome); $i++)
                   {
                       ...
                       echo("<td colspan='2'> T7 R$ " . formata_moeda($cestante_valor[$i]*$valor_taxa) .  "</td>");
					   echo("<td colspan='2'> T8 R$ " . formata_moeda(($cestante_valor_entregue[$i] - $cestante_valor[$i])*$valor_taxa) .  "</td>");	
					   echo("<td colspan='2'> T9 R$ " . formata_moeda($cestante_valor_entregue[$i]*$valor_taxa) .  "</td>");
				
                   }                                            
                   ?>                  
            <th colspan="2">Y1 R$ <?php echo(formata_moeda($total)); ?></th>
            <th colspan="2">Y2 R$ <?php echo(formata_moeda($total_entregue - $total)); ?></th>
            <th colspan="2">Y3 R$ <?php echo(formata_moeda($total_entregue)); ?></th>
           ...
           <tr>
            <th colspan="4" style="text-align:right">Q4 Total Final</th>
				  <?php
				  $total=0.0;
				  $total_entregue=0.0;
                   for ($i = 0; $i < count($cestante_nome); $i++)
                   {	
					...
					$total_entregue+=$valor_final_entregue;
                        echo("<th colspan='2' align='center'>U1 R$ " . formata_moeda($valor_final) .  "</th>");	
                        echo("<th colspan='2' align='center'>U2 R$ " . formata_moeda($valor_final_entregue - $valor_final) .  "</th>");	
                        echo("<th colspan='2' align='center'>U3 R$ " . formata_moeda($valor_final_entregue) .  "</th>");																					
                   }                                            
                   ?>                  
            <th colspan="2">I1 R$ <?php echo(formata_moeda($total)); ?></th>
            <th colspan="2">I2 R$ <?php echo(formata_moeda($total_entregue - $total)); ?></th>          
            <th colspan="2">I3 R$ <?php echo(formata_moeda($total_entregue)); ?></th>            
