...
<?php 
 ...
 <table class="table-condensed table-info-cadastro">
		<tbody>
    		...
    		<tr>
				<th>Taxa de Frete:</th>	<td><?php echo($cha_taxa_percentual); ?></td>
			</tr>
    		<tr>
     ...
     <div class="panel-body">
          ...
          <input type="hidden" name="action" value="<?php echo(ACAO_SALVAR); ?>" />  
            ...
            <div class="form-group">
               <label class="control-label col-sm-2" for="cha_taxa_percentual">Taxa de Frete</label>
                 <div class="col-sm-2">
            	  ...
            	  (Santa Teresa) = R$ 3,00; 
            	  (Centro, Glória, Catete, Laranjeiras) = R$ 5,00; 
            	  (Grande Tijuca, Grande Méier*, Ilha do Governador*, Barra, Itanhangá, São Conrado) = R$ 12,00</span>
            </div>
