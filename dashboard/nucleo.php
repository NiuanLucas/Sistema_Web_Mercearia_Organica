...
<?php
		...
		else if ($action == ACAO_SALVAR) // salvar formulário preenchido
		{
			 ...
			 if($res) 
			 {
				...
				adiciona_mensagem_status(MSG_TIPO_SUCESSO,"Informações da Área de entrega " . $_REQUEST["nuc_nome_curto"] . " salvas com sucesso.");
			 }
			 else
			 {
				adiciona_mensagem_status(MSG_TIPO_ERRO,"Erro ao tentar salvar informações da Área de entrega " . $_REQUEST["nuc_nome_curto"] . ".");				 
			 }
...
<div class="panel panel-default">
  <div class="panel-heading">
     <strong>Informações da Área de entrega</strong>
  </div>
...
<table class="table-condensed table-info-cadastro">
      ...
      <div class="panel-footer">
         	...
         	&nbsp;&nbsp;
           <a class="btn btn-danger" href="nucleo.php?action=<?php echo(ACAO_EXIBIR_EDICAO); ?>&nuc_id=<?php echo($nuc_id); ?>&excluir=1"><i class="glyphicon glyphicon-remove"></i> apagar área de entrega </a>&nbsp;&nbsp;
          &nbsp;&nbsp;
         		<a class="btn btn-default" href="nucleos.php"><i class="glyphicon glyphicon-list"></i> listar áreas de entrega</a>
             </div>
       </div>
...
<div class="panel panel-default">
  <div class="panel-heading">
     <strong>Atualização de Informações da Área de entrega</strong>
  </div>
