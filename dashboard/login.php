...
<?php
if(isset($_GET["enter"])) {
adiciona_mensagem_status(MSG_TIPO_SUCESSO," Cadastro concluído com Sucesso, utilize seu login e senha criados abaixo. ");
}
?>
     ...
     <form class="form-signin" action="login.php" method="POST" role="form">     
       ...
       <br>
			...
			<div align="right">Não tem cadastro?&nbsp;<a href="cadastro.php">Clique aqui para se cadastrar</a></div>	
			<div class="clear"></div>
      </form>
